...
!function(e) {
    ...
    i = 0, (r = function(e, t) {
        ...
        if (e.calculateDays(), !e.$elements.calendarEl.html()) {
            for (var t = '<div class="calendar-sidebar"><div class="calendar-year"> &nbsp;<p></p>&nbsp;</div><div class="month-list"><ul class="calendar-months">', a = 0; a < e.$label.months.length; a++) t += '<li class="month" role="button" data-month-val="' + a + '">' + e.initials.dates[e.options.language].months[a] + "</li>";
